...
public class ImageController {
    ...
    /***
     * @param productId productId property is used to determine for what product wil be added @param productId
     ...
     * @throws IOException can be thrown if something goes wrong with param  in File Sistem
     */
    ...
    /***
     *
     * @param productId productId property is used to determine for what product wil be updated @param productId
     * @param images  property is used to get the image with specific name that will be updated the current image
     * @param userId   property is used to determine if the user has authorisation to make changes in database
     * @return responseDto to inform front-end that process has been done successfully/ failed
     */
